...
class ResNet(nn.Module):
    def __init__(self, block, layers, num_classes=2):
        ...
        self.fc=nn.Sequential(nn.Linear(512,256), nn.ReLU(inplace=True), nn.Dropout(0.5), nn.Linear(256, 128), 
                              nn.ReLU(inplace=True), nn.Dropout(0.5), nn.Linear(128,2, bias=True))
